...
description: "Learn how to authenticate with the Pixie API"
icon: "key"
---
...
Generate API keys from the Developer Dashboard at www.neyrs.cloud/dashboard

### Key Format

```
pixie_live_abc123def456
pixie_test_xyz789ghi012
```
...
```typescript
const pixie = new PixieSDK({
  apiKey: process.env.PIXIE_API_KEY
});
```
