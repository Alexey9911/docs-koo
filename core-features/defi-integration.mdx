...
Neyrs uses Jupiter V6 to aggregate liquidity across all Solana DEXs, ensuring best price execution with minimal slippage.
...
Jupiter quotes expire after 30 seconds due to price volatility. Neyrs automatically refreshes quotes if:
...
Neyrs uses Jupiter V6 SDK for route calculation:
