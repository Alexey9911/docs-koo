...
Pixie's NLP engine parses natural language input and extracts transaction parameters without requiring complex UI interactions.
...
Pixie supports multiple address formats:
...
If the parser cannot extract required parameters, Pixie will prompt for clarification:

**User:** "Swap SOL"

**Pixie:** "How much SOL would you like to swap, and for which token?"

**User:** "10 SOL for USDC"

**Pixie:** *Proceeds with transaction*
