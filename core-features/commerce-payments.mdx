...
Pixie enables e-commerce purchases using USDC through integrated payment processing.
...
<Steps>
  <Step title="Request Purchase">
    Tell Pixie what you want to buy using natural language
  </Step>
  <Step title="USDC Calculation">
    Pixie calculates required USDC amount at current exchange rate
  </Step>
...
Pixie uses real-time USDC/USD rates with minimal markup:
...
<Card title="Payment Processor" icon="building" href="https://www.neyrs.cloud">
