...
<img src="/images/hero-dark.png" alt="Pixie Banner" className="hidden dark:block mb-8 rounded-xl" />
<img src="/images/hero-light.png" alt="Pixie Banner" className="block dark:hidden mb-8 rounded-xl" />

# Pixie

Pixie is an autonomous AI agent that executes Solana blockchain operations through natural language. Send tokens, swap assets, stake SOL, check balances, and purchase goods with USDC—all through conversational commands.
...
<Card title="Get Started" icon="rocket" href="/introduction/quickstart">
  Start using Pixie in under 5 minutes
</Card>
