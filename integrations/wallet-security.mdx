...
Pixie is designed with security as a core principle. Understanding wallet security best practices is essential for safe DeFi operations.

## Non-Custodial Architecture

Pixie never has access to your private keys or seed phrases.

<CardGroup cols={2}>
  <Card title="Read-Only Connection" icon="eye">
    Pixie only reads your public wallet address
  </Card>
...
<Steps>
  ...
  <Step title="Connect to Pixie">
    Use this burner wallet for all Pixie interactions
  </Step>
...
**Protection:**
- Bookmark official Pixie URL (neyrs.cloud)
...
- Pixie will never ask for your seed phrase
- Store seed phrases offline in secure location

## Wallet Permissions

When you connect to Pixie, you grant these permissions:
...
To disconnect your wallet from Pixie:

<Steps>
  <Step title="Click Disconnect">
    Use the disconnect button in Pixie interface
  </Step>
  <Step title="Revoke in Wallet">
    Open wallet settings and revoke Pixie's connection
  </Step>
...
<Note>
  Pixie's security model ensures that even if the Pixie website is compromised, your funds remain safe because private keys never leave your wallet.
</Note>
